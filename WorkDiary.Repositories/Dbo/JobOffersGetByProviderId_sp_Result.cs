...
namespace WorkDiaryRepository.Dbo
{
    ...
    public partial class JobOffersGetByProviderId_sp_Result
    {
        ...
        public Nullable<decimal> LAST_OFFER_AMOUNT { get; set; }
        public Nullable<decimal> LAST_OFFER_AMOUNT_SERVICE_FEE { get; set; }
        public Nullable<decimal> LAST_OFFER_AMOUNT_CLIENT_CHARGED { get; set; }
